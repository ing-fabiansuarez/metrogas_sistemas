                  ...
                  <a class="nav-link me-2" href="{{ route('login') }}">
                    ...
                    Sign In
                            ...
                            <ul class="navbar-nav d-lg-block d-none">
                                <li class="nav-item">
                                    <button
                                        class="btn btn-sm mb-0 me-1 bg-gradient-dark">{{ auth()->user()->name }}</button>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container my-auto text-center">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="text-light">Sin Autorización </h2>
                        <h4 class="text-light">Ooooups! No tienes autorización para ingresar a esta sección.</h4>
                    </div>
                </div>
            </div>
